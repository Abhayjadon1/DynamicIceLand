package com.miniature.dynamiciceland.lock.fragment;
...
import com.miniature.dynamiciceland.lock.activites.AppsFilterListActivity;
import com.miniature.dynamiciceland.lock.activites.AppsListActivity;
import com.miniature.dynamiciceland.lock.activites.HelpActivity;
import com.miniature.dynamiciceland.lock.activites.HomeActivity;

import com.miniature.dynamiciceland.lock.background.PrefManager;
import com.miniature.dynamiciceland.lock.background.Utils;
import com.miniature.dynamiciceland.lock.background.WallpapersCategoryActivity;
import com.miniature.dynamiciceland.lock.utils.Constants;
import com.miniature.dynamiciceland.lock.utils.MySettings;
import com.miniature.dynamiciceland.lock.utils.RatingDialog;
    ...
    public void onClick(View view) {
        ...
        if (viewId == R.id.cv_tile_color) {
            ColorPickerDialog.Builder negativeButton = new ColorPickerDialog.Builder(this.context).setTitle((CharSequence) "Pick tiles color").setPositiveButton((CharSequence) getString(R.string.confirm), (ColorPickerViewListener) new SettingsFragment$$ExternalSyntheticLambda7(this)).setNegativeButton((CharSequence) getString(R.string.cancel), (DialogInterface.OnClickListener) new SettingsFragment$$ExternalSyntheticLambda8());
                ...
                negativeButton.show();
        } else if (viewId == R.id.help_rl) {
            showHelpScreen();
        } else if (viewId == R.id.privacy_rl) {
        ...
        } else if (viewId == R.id.rl_appsFilterList) {
        ...
        } else if (viewId == R.id.rl_appsList) {
