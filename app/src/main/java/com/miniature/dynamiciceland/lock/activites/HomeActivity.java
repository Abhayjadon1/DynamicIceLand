...
import com.miniature.dynamiciceland.lock.adaptar.ViewPagerAdapter;
...
public class HomeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        } else if (viewId == R.id.permission_btn) {
            if (this.drawer.isDrawerOpen((int) GravityCompat.START)) {
                this.drawer.closeDrawer((int) GravityCompat.START);
            }
            startActivity(new Intent(this, PermissionsActivity.class));
        } else if (viewId == R.id.rate_us_btn) {
            if (this.drawer.isDrawerOpen((int) GravityCompat.START)) {
                this.drawer.closeDrawer((int) GravityCompat.START);
            }
            try {
        ...
        } else if (viewId == R.id.remove_ads_btn) {
            if (this.drawer.isDrawerOpen((int) GravityCompat.START)) {
                this.drawer.closeDrawer((int) GravityCompat.START);
            }
            // Your code for remove_ads_btn
        }
